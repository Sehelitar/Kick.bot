    ...
    public sealed class BotClient
    {
        ...
        public static bool CheckCompatibility(uint rev = 0)
        {
            ...
            if(rev < ActionRevision)
            {
                ...
                MessageBox.Show($"Please click on \"Import\" and import actions.txt from Kick.bot archive into Streamer.bot to update Kick.bot C# code.", "Kick.bot - Action update required", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);
                return false;
            }
